...
def main():
        keyCount = 5
        #gemerate probabilities [0.425, 0.025, 0.15, 0.4]
        probabilities = {SAFE: 0.425, LOST: 0.025, LEAKED: 0.15, STOLEN: 0.4}
        optimal_wallet, optimal_success_probability, optimal_threshold = find_optimal_symmetric_wallets(keyCount, probabilities, verbose=True)
