...
from . import optimal_symmetric_wallets
...
def calculate_wallet_differences(
    ...
    for probabilities in probabilities_list:
        _opt_wallet, _opt_prob, k = optimal_symmetric_wallets.find_optimal_symmetric_wallets(
...
if __name__ == "__main__":
    ...
    if result:
        ...
        print(
            f"  success_full={success_full:.6f}, success_forbidden={success_forbidden:.6f}"
        )
    else:
